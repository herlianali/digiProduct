            ...
            <div class="w-full max-w-[1600px] mx-auto px-4">
                <div class="grid grid-cols-12 gap-4">
                    ...
                    <div class="col-span-3 bg-[#fce109] rounded-2xl p-4 flex flex-col relative overflow-hidden ">
                        ...
                        <p class="text-xs md:text-sm text-black/80 mt-2 max-w-[55%] leading-relaxed flex-1">Most people freeze at the starting line. Don't hesitate. Just give it a shot.</p>
                        <div>
                    ...
                    <div class="col-span-2 row-span-2 bg-gray-200 border border-black rounded-2xl flex flex-col overflow-hidden">
                        <div class="flex justify-center items-center py-3">
                            <img src="/public/assets/image/banner/card-service-animated2.svg" class="w-[18em] h-[7em]" alt="" />
                        </div>
                        <div class="bg-black rounded-tl-2xl rounded-tr-2xl">
                            <h3 class="font-bold text-white px-4 py-1 text-sm">Design Service</h3>
                            <div class="rounded-t-2xl bg-gray-200">
                                <p class="text-[9px] md:text-[10px] text-gray-500 leading-relaxed px-4 py-2">
                                    Brand Identity / Logo Design / Poster<br />Design / Packaging Design / Social<br />
                                    Media Design / Infographic Design /<br />Editorial Design / Book Design
                                </p>
                                <div class="bg-black rounded-tl-2xl rounded-tr-2xl">
                                    <h3 class="font-bold text-white px-4 py-1 text-sm">Illustration Service</h3>
                                    <div class="rounded-t-2xl bg-gray-200">
                                        <p class="text-[9px] md:text-[10px] text-gray-500 leading-relaxed px-4 pt-2">
                                            2D Illustration / Environmental Design<br />Game Design / Character design /<br />
                                            Mascot Illustration / Advertising<br />Illustration
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="pb-1 flex justify-center">
                            <img src="/public/assets/image/banner/arrow-black-bottom.svg" alt="" class="w-4 h-4" />
                        </div>
                    ...
                    <!-- Col 6-7: Teepublic -->
                    <div class="col-span-2 bg-[#4c60d8] rounded-2xl flex flex-col min-h-[140px]">
                    ...
                    <div class="col-span-3 bg-black rounded-2xl flex flex-col overflow-hidden min-h-[140px]">
                        <div class="px-3 pt-2 flex justify-between items-start">
                            <div>
                                <p class="font-bold text-white text-2xl leading-tight">Bē</p>
                                <p class="text-[9px] text-white leading-tight">More<br />Professional<br />Portofolio</p>
                            </div>
                            <img src="/public/assets/image/banner/arrow-white-right.svg" alt="" class="w-5 h-5" />
                        </div>
                        <div class="flex-1 overflow-hidden">
                    ...
                    <div class="col-span-2 row-span-2 flex flex-col gap-3">
                        ...
                        <div class="bg-black rounded-2xl flex flex-col overflow-hidden ">
                            <div class="px-6 pt-4 relative">
                                <p class="text-lg text-white uppercase">New Seller</p>
                                <p class="text-white text-lg">on <b class="font-['Archivo_Black',sans-serif]">upwork</b></p>
                                <!-- <ArrowUpRightSolid class="absolute top-2 right-2 text-white w-3 h-3" /> -->
                            ...
                            <div class="flex-1 flex flex-col justify-end overflow-hidden">
                                ...
                                <div class="rounded-t-2xl bg-[#268a00] px-3 py-1">
                                    <p class="text-white text-[10px] font-extrabold leading-tight">Enjoy many Bonuses<br />and Discounts<br />on this Platform!</p>
                                    <p class="text-[7px] text-white/80 mt-0.5">Help us<br />to grow even more :)</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-span-5 flex flex-col gap-4">
                        <div class="bg-[#f2ecea] rounded-2xl p-2 relative overflow-hidden h-[150px]">
                            <div class="flex justify-between items-start">
                                <div>
                                    <p class="text-[8px] font-semibold text-gray-500">Top Rated</p>
                                    <p class="text-sm font-black text-black">Badge on <em class="italic">fiverr</em>.</p>
                                </div>
                                <div class="flex flex-col items-end gap-0.5">
                                    <ArrowUpRightSolid class="text-gray-600 w-3 h-3" />
                                    <span class="bg-orange-600 text-white text-[7px] font-bold px-1.5 py-0.5 rounded-full">TOP RATED</span>
                                </div>
                            </div>
                            <div class="absolute bottom-0 left-0 h-[70%] w-[40%] overflow-hidden">
                            ...
                            <div class="absolute bottom-1 right-2 text-right">
                                <span class="text-[7px] text-gray-500 block">For secure</span>
                                <span class="text-[7px] text-gray-500 block">transactions!</span>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-12 gap-4 flex-1 max-h-[260px]">
                            <div class="col-span-5 bg-[#fee100] rounded-2xl p-2 relative overflow-hidden">
                                <div class="absolute left-1/2 bottom-0 -translate-x-1/2 w-0 h-0 z-0 border-l-[200px] border-r-[200px] border-b-[70px] border-l-transparent border-r-transparent border-b-[#f5a800]"></div>
                                <p class="font-extrabold text-black text-xl relative z-20">Our<br />Product</p>
                                <div class="flex-1 flex items-center justify-center py-1 relative z-10">
                                    <img src="/public/assets/image/banner/card-ourproduct-animated.svg" alt="product" class="w-[70%] h-[70%] object-contain" />
                                </div>
                                <div class="text-center relative z-10">
                                    <img src="/public/assets/image/banner/arrow-black-bottom.svg" alt="Arrow" class="inline w-4 h-4" />
                                </div>
                            </div>

                            <div class="col-span-7 bg-[#abdec9] rounded-2xl relative overflow-hidden">
                                <img src="/public/assets/image/banner/card-ourteam-animated.svg" alt="team" class="w-[80%] h-[80%] object-cover" />
